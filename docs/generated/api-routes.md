...
| 方法 | 路径 | 风险 | 查询字段 | 请求体 | 响应 | 证据等级 |
|---|---|---|---|---|---|---|
| `DELETE` | `/api/ddns` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/ddns/manualSync/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `PUT` | `/api/ddns/{param}/{param2}/option/{param3}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/docker/compose/{param}/backups/download.tar.gz` | `read-only` | `backup` | — | `blob` | `runtime-verified` |
...
| `DELETE` | `/api/docker/container-groups` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/docker/containers/{param}/label` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `POST` | `/api/docker/containers/{param}/pause` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/docker/images/upgrade-status` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/docker/images/{param}/filesystem` | `read-only` | `path` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/docker/images/{param}/tags` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/docker/networks/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/docker/tasks` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/docker/tasks/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/docker/tasks/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/frp/{param}/proxies/{param2}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/ipdb/dbfile` | `mutating` | `file`, `key` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/ipdb/item` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/ipdb/item/{param}/{param2}` | `read-only` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/ipdb/items` | `read-only` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/ipdb/logs` | `read-only` | `page`, `pageSize` | — | `json` | `runtime-verified` |
| `GET` | `/api/ipdb/query` | `read-only` | `ip` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/ipfliter/list/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/oauth/status` | `read-only` | `code`, `type` | — | `json` | `runtime-verified` |
| `GET` | `/api/oauth/tmpcode` | `dangerous` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/oauth/userinfo` | `read-only` | `code`, `type` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/portforward/enable` | `mutating` | `enable`, `key` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/rclone/third/115pan/authcheck/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/rclone/third/alipan/authcheck/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/rclone/third/baidupan/authcheck/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| 方法 | 路径 | 风险 | 查询字段 | 请求体 | 响应 | 证据等级 |
|---|---|---|---|---|---|---|
| `GET` | `/api/restoreconfigureconfirm` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/security-groups/grants/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/security-groups/oauth-users/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/security-groups/users/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/security-groups/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| 方法 | 路径 | 风险 | 查询字段 | 请求体 | 响应 | 证据等级 |
|---|---|---|---|---|---|---|
| `DELETE` | `/api/ssl` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `PUT` | `/api/ssl/flush` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `GET` | `/api/ssl/manualsync/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `PUT` | `/api/ssl/{param}` | `mutating` | `enable` | — | `json` | `runtime-verified` |
| `DELETE` | `/api/ssl/{param}/acmecancel` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/storagemanagement/aliyunpan_auth_check/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| 方法 | 路径 | 风险 | 查询字段 | 请求体 | 响应 | 证据等级 |
|---|---|---|---|---|---|---|
| `GET` | `/api/twofapassword` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `PUT` | `/api/webservice/cgi/{param}/{param2}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/webservice/discovery/latest` | `read-only` | `ruleKey` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/webservice/groups` | `mutating` | `key` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/webservice/rule/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/webservice/rule/{param}/{param2}/{param3}` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `POST` | `/api/webservice/statistics/ip-info-refresh/cancel` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/webservice/{param}/{param2}/corazalogs` | `read-only` | `page`, `pageSize` | — | `json` | `runtime-verified` |
| `GET` | `/api/webservice/{param}/{param2}/lastlogs` | `read-only` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/webservice/{param}/{param2}/logs` | `read-only` | `page`, `pageSize` | — | `json` | `runtime-verified` |
| `DELETE` | `/api/webservice/{param}/{param2}/updatefolder/cancel/{param3}` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/webterminal/connections/{param}/ssh-host-key` | `mutating` | — | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/webterminal/sessions/{param}` | `mutating` | — | — | `json` | `runtime-verified` |
| `GET` | `/api/webterminal/sessions/{param}` | `read-only` | — | — | `json` | `runtime-verified` |
| `PUT` | `/api/webterminal/sessions/{param}/remark` | `mutating` | — | `remark` | `json` | `runtime-verified` |
| `GET` | `/api/webterminal/sessions/{param}/stats` | `read-only` | — | — | `json` | `runtime-verified` |
...
| `GET` | `/api/webterminal/sftp/{param}/list` | `read-only` | `path` | — | `json` | `runtime-verified` |
...
| `DELETE` | `/api/webterminal/splitlayout` | `mutating` | — | — | `json` | `runtime-verified` |
